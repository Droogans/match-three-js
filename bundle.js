...
},{"./generic-collection":2,"./generic-map":3,"./listen/property-changes":8,"./shim":14}],2:[function(require,module,exports){
"use strict";
...
},{"./shim-array":10}],3:[function(require,module,exports){
"use strict";
...
},{"./listen/map-changes":7,"./listen/property-changes":8,"./shim-object":12}],4:[function(require,module,exports){
...
},{"./shim-object":12}],5:[function(require,module,exports){
...
},{"./generic-collection":2,"./generic-order":4,"./listen/property-changes":8,"./listen/range-changes":9,"./shim":14}],7:[function(require,module,exports){
"use strict";
...
},{"../dict":1,"../list":6,"weak-map":18}],8:[function(require,module,exports){
/*
...
},{"../shim":14}],9:[function(require,module,exports){
"use strict";
...
},{"../dict":1,"weak-map":18}],10:[function(require,module,exports){
"use strict";
...
},{"./generic-collection":2,"./generic-order":4,"./shim-function":11,"weak-map":18}],11:[function(require,module,exports){
...
},{"weak-map":18}],13:[function(require,module,exports){
...
},{"./generic-collection":2,"./generic-set":5,"./listen/property-changes":8,"./listen/range-changes":9,"./shim":14,"./tree-log":16}],16:[function(require,module,exports){
"use strict";
...
},{"./animationHelpers":19,"lodash":17}],21:[function(require,module,exports){
(function (global){
'use strict';
...
},{"../../src/board":22,"./animationHelpers":19,"./demotools":20,"lodash":17}],22:[function(require,module,exports){
'use strict';
Object.defineProperty(exports, "__esModule", { value: true });
var _ = require("lodash");
var orbs = require("./orbs");
var triples = require("./triples");
var Board = /** @class */ (function () {
    function Board(width, height, types, needsAttic) {
        if (width === void 0) { width = 8; }
        if (height === void 0) { height = 8; }
        if (types === void 0) { types = _.range(7); }
        if (needsAttic === void 0) { needsAttic = true; }
        this.width = width;
        this.height = height;
        this.types = types;
        this.generateOrbs();
    ...
    Object.defineProperty(Board.prototype, "availableTypes", {
        get: function () {
    ...
    Object.defineProperty(Board.prototype, "triples", {
        get: function () {
    ...
    Object.defineProperty(Board.prototype, "matches", {
        get: function () {
    ...
    Board.prototype.generateOrbs = function () {
        var _this = this;
        var chooseOrb = function () { return _.sample(_this.types); };
        var sampleRow = function () { return _.times(_this.width, chooseOrb); };
        this.orbs = _.zip.apply(_, _.times(this.height, sampleRow));
    };
    Board.prototype.resetAttic = function () {
        this.attic = new Board(this.width, this.height, this.types, false);
    };
    Board.prototype.evaluate = function () {
        var _a = orbs.evaluate(this.orbs, this.matches, this.attic.orbs), newOrbs = _a[0], matchData = _a[1];
        this.orbs = newOrbs;
        return matchData;
    };
    Board.prototype.needsShuffle = function () {
        return !this.hasPotentialMatch();
    };
    Board.prototype.hasPotentialMatch = function () {
        return orbs.hasPotentialMatch(this.orbs);
    };
    Board.prototype.hasMatch = function () {
        return Boolean(triples.find(this.orbs)[0]);
    };
    Board.prototype.swap = function (swapOrbs) {
        this.orbs = orbs.swap(this.orbs, swapOrbs);
    };
    Board.prototype.unmatch = function () {
        while (this.hasMatch()) {
            this.orbs = orbs.unmatch(this.orbs, this.matches[0]);
        }
    };
    Board.prototype.shuffle = function () {
        this.orbs = _.map(this.orbs, function (row) { return _.shuffle(row); });
        this.unmatch();
...
},{"./orbs":24,"./triples":26,"lodash":17}],23:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var _ = require("lodash");
/**
...
/**
  ...
  * of '\u241a'
  */
function markMatches(orbs, matches) {
    var matchData = [];
    _.each(matches, function (match) {
...
exports.getOrbCounts = getOrbCounts;
;
/**
  ...
  * @see activateGravity
  */
function getBlanksBelow(orbs) {
    var blanksBelow = {};
    var height = orbs[0].length;
    var width = orbs.length;
    _.each(_.rangeRight(width - 1), function (row) {
        _.each(_.range(height), function (col) {
            var blankCount = 0;
            _.each(_.range(1, height - row), function (adder) {
...
exports.getBlanksBelow = getBlanksBelow;
;
/**
  ...
  * by this function.
  */
function activateGravity(orbs) {
    var orbsBefore = orbs;
    _.each(getBlanksBelow(orbs), function (count, coord) {
        var _a = _.map(coord.split(','), _.toInteger), row = _a[0], col = _a[1];
...
/**
  ...
  * @see releaseAttic
  */
function atticOrbsToDropDown(atticOrbs, col, count) {
    var lastRow = atticOrbs.length;
    var atticOrbsToDropDown = [];
    _.each(_.range(count), function (n) {
        atticOrbsToDropDown.push(atticOrbs[lastRow - 1 - n][col]);
    });
    return atticOrbsToDropDown;
}
exports.atticOrbsToDropDown = atticOrbsToDropDown;
;
/**
  * @description Drops down the necessary orbs from the attic into the main orb set.
  */
function releaseAttic(orbs, atticOrbs, orbCounts) {
    _.each(orbCounts, function (count, col) {
        var dropdowns = atticOrbsToDropDown(atticOrbs, col, count);
        _.each(_.range(count), function (row) {
...
function hasPotentialMatchInPairOfRows(pairOfRows) {
    ...
    var allMatches = _.map(allValues, function (value) {
        return _.uniq(tools.indexOfAll(pairOfRows[0], value).concat(tools.indexOfAll(pairOfRows[1], value))).sort();
    });
...
function hasPotentialMatch(orbs) {
    ...
    var chunks = [];
    _.each(walk_1.walk.entireBoard(orbs), function (metadata) {
        chunks.push(metadata.orbs);
    });
    // [[1, 2, 3], [4, 5, 6], [6, 5, 4], [3, 2, 1]]
    var flatChunks = _.flatten(chunks);
...
function swap(orbs, swapOrbs) {
    var _a = swapOrbs[0], row1 = _a[0], col1 = _a[1], _b = swapOrbs[1], row2 = _b[0], col2 = _b[1];
...
/**
  ...
  * @see unmatch
  */
var _unmatch = function (orbs, row, col, match, skipToRandom) {
    if (skipToRandom === void 0) { skipToRandom = false; }
    ...
    while (!swapped) {
        var _a = [_.random(orbs.length - 1), _.random(orbs[0].length - 1)], randomRow = _a[0], randomCol = _a[1];
...
/**
  ...
  */
function unmatch(orbs, match) {
    var intersections = [];
    // it is a simple match if all of the coords have only 1 rowCoord or 1 colCoord
    var _a = _.zip.apply(_, match), rowCoords = _a[0], colCoords = _a[1];
    ...
    if (isSimpleMatch) {
        ...
        var _b = match[median], midRow = _b[0], midCol = _b[1];
...
},{"./evaluate":23,"./tools":25,"./walk":27,"lodash":17}],25:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var _ = require("lodash");
...
var _findTriples = function (chunks, isTransposed) {
    var triples = [];
    _.each(chunks, function (chunk) {
        var orbs = chunk.orbs[0];
        if (_.uniq(orbs).length === 1) {
            var anchor = chunk.positionInfo.first;
            var firstOrb = anchor;
...
/**
  ...
  */
function find(orbs) {
    var horizontalChunks = walk_1.walk.horizontally(orbs, [3, 1], true);
    var verticalChunks = walk_1.walk.vertically(orbs, [3, 1], true);
    return _findTriples(horizontalChunks, false).concat(_findTriples(verticalChunks, true));
}
exports.find = find;
;
...
},{"./walk":27,"collections/sorted-set":15,"lodash":17}],27:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var _ = require("lodash");
exports.walk = {
...
function horizontally(orbs, chunkLimitRange, includePositionInformation) {
    if (chunkLimitRange === void 0) { chunkLimitRange = [4, 2]; }
    if (includePositionInformation === void 0) { includePositionInformation = false; }
    return _walkBoard(orbs, chunkLimitRange, includePositionInformation, false);
}
function vertically(orbs, chunkLimitRange, includePositionInformation) {
    if (chunkLimitRange === void 0) { chunkLimitRange = [4, 2]; }
    if (includePositionInformation === void 0) { includePositionInformation = false; }
    return _walkBoard(_.zip.apply(_, orbs), chunkLimitRange, includePositionInformation, true);
}
function entireBoard(orbs, chunkLimitRange, includePositionInformation) {
    if (chunkLimitRange === void 0) { chunkLimitRange = [4, 2]; }
    if (includePositionInformation === void 0) { includePositionInformation = false; }
    return horizontally(orbs, chunkLimitRange, includePositionInformation).concat(vertically(orbs, chunkLimitRange, includePositionInformation));
}
/**
 * @private
 ...
 * @see findTriples
 */
function _walkBoard(orbs, chunkLimitRange, includePositionInformation, isTransposed) {
    var chunks = [];
    var width = chunkLimitRange[0], height = chunkLimitRange[1];
    var _a = [orbs[0].length - width, orbs.length - height], finalPositionWidth = _a[0], finalPositionHeight = _a[1];
    _.each(_.range(0, finalPositionHeight + 1), function (heightIndex) {
        _.each(_.range(0, finalPositionWidth + 1), function (widthIndex) {
            var chunk = { orbs: undefined };
            chunk.orbs = orbs.slice(heightIndex, heightIndex + height).map(function (row) {
 ...
 * ]
 */
function walkBoard(orbs, chunkLimitRange, includePositionInformation) {
    if (chunkLimitRange === void 0) { chunkLimitRange = [4, 2]; }
    if (includePositionInformation === void 0) { includePositionInformation = false; }
    var transposedOrbs = _.zip.apply(_, orbs);
    return _walkBoard(orbs, chunkLimitRange, includePositionInformation, false).concat(_walkBoard(transposedOrbs, chunkLimitRange, includePositionInformation, true));
}
exports.walkBoard = walkBoard;
;
